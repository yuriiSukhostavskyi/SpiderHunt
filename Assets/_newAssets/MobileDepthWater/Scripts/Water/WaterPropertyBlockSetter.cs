namespace Assets.Scripts.Water
{
    ...
    {
        [SerializeField] private List<Renderer> waterRenderers = new List<Renderer>();
        ...
        public void SetToWater(Renderer objectForWater)
        {
            waterRenderers.Add(objectForWater);
        }

        public void UnSetFromWater(Renderer objectForWater)
        {
            waterRenderers.Remove(objectForWater);
        }
